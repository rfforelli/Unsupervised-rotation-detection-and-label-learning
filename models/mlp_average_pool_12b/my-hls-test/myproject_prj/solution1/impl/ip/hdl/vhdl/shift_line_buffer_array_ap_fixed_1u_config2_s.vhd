...
begin
    ...
    line_buffer_Array_V_2_0_U : component shift_line_buffer_array_ap_fixed_1u_config2_s_line_bufferbkb
    generic map (
        DataWidth => 16,
        AddressRange => 120,
        AddressWidth => 7)
    ...
    ap_return_10 <= kernel_window_10_V_read;
    ap_return_11 <= kernel_window_11_V_read;
    ap_return_12 <= line_buffer_Array_V_0_0_q0;
    ap_return_13 <= kernel_window_14_V_read;
    ap_return_14 <= kernel_window_15_V_read;
    ap_return_15 <= in_elem_data_V_read;
    ap_return_2 <= kernel_window_9_V_read;
    ap_return_3 <= kernel_window_13_V_read;
    ap_return_4 <= kernel_window_2_V_read;
    ap_return_5 <= kernel_window_3_V_read;
    ap_return_6 <= line_buffer_Array_V_2_0_q0;
    ap_return_7 <= kernel_window_6_V_read;
    ap_return_8 <= kernel_window_7_V_read;
    ap_return_9 <= line_buffer_Array_V_1_0_q0;
    ...
    line_buffer_Array_V_2_0_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    line_buffer_Array_V_2_0_we0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_ce)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
